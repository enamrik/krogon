...
class K8sStep(Step):
    ...
    def exec(self, scripter: scp.Scripter, fs: FileSystem) -> E.Either:
        return _exec_in_clusters(self.cluster_tag, self.k8s_deployments, scripter, fs)
...
def _exec_in_clusters(cluster_tag: str,
    ...
    def _exec_deployment(deployment: K8sDeployment):
        ...
        if type(deployment) == K8sSecretDeployment:
            ...
            return cur_deployment.exec(cluster_tag, scripter, fs)
